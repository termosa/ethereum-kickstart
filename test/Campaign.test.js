...
const compiledFactory = require('../ethereum/build/Campaign/CampaignFactory.json')
const compiledCampaign = require('../ethereum/build/Campaign/Campaign.json')
...
describe('Campaigns', () => {
  ...
  it('allows people to contribute money and marks them as approvers', async () => {
    await campaign.methods.contribute()
      .send({ value: '200', from: accounts[2] })
  ...
  it('processes requests', async () => {
    ...
    await campaign.methods.createRequest('A', web3.utils.toWei('5', 'ether'), accounts[3])
      .send({ from: accounts[1], gas: '1000000' })
